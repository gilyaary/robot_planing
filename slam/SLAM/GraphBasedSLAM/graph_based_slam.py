...
def main():
    ...
    x1 = np.random.random(20)*30 * np.random.randint(-1,1)
    x2 = np.random.random(20)*30  * np.random.randint(-1,1)
    y1 = np.random.random(20)*30
    y2 = (np.random.random(20)*30)
    RFID = np.hstack((x1,x2,y1,y2)).reshape((40,2))
